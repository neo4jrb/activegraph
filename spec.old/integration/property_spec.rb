...
describe BooleanProperties, :type => :integration do
...
describe FixnumProperties, :type => :integration do
...
describe FloatProperties, :type => :integration do
  context "before save" do
    before(:each) do
      subject.val = "3.14"
    end
...
describe RequiredProperty, :type => :integration do
...
describe LengthProperty, :type => :integration do
...
describe DefaultProperty, :type => :integration do
...
describe LotsaProperties, :type => :integration do
	it "should have 3 callbacks" do
		subject.class._validate_callbacks.size.should == 3
	end
end

describe DateProperties, :type => :integration do
  before(:each) do
