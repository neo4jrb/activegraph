module Neo4j::Shared
  module Property
    ...
    NEO4J_DRIVER_DATA_TYPES = [String, Integer, Date, DateTime, Time, Float, Hash, Enumerable, Neo4j::Driver::Types::Bytes,
                               ActiveSupport::Duration, Neo4j::Driver::Types::Point]
