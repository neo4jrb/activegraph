module ActiveGraph
  ...
  module ActiveRel
    ...
    include ActiveGraph::ActiveRel::Persistence
    include ActiveGraph::ActiveRel::Validations
    include ActiveGraph::ActiveRel::Callbacks
    include ActiveGraph::ActiveRel::Query
    ...
    def node_or_nil(node)
      node.is_a?(ActiveGraph::ActiveNode) || node.is_a?(Integer) ? node : nil
    end
