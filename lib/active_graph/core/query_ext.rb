module ActiveGraph
  module Core
    class Query
      # Creates a ActiveGraph::ActiveNode::Query::QueryProxy object that builds off of a Core::Query object.
      #
      ...
      # @return [ActiveGraph::ActiveNode::Query::QueryProxy] A QueryProxy object.
      def proxy_as(model, var, optional = false)
        ...
        ActiveGraph::ActiveNode::Query::QueryProxy.new(model, nil, node: var, optional: optional, starting_query: self, chain_level: @proxy_chain_level)
      end
