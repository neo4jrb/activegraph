module ActiveGraph::ActiveRel::Persistence
  ...
  class QueryFactory
    ...
    # TODO: This feels like it should also wrap the rel, but that is handled in ActiveGraph::ActiveRel::Persistence at the moment.
    ...
    # @param [ActiveGraph::ActiveNode] node A node, persisted or unpersisted
