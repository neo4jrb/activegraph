    ...
    class << self
      def wrapper(rel)
        ...
        begin
          ...
          return rel unless most_concrete_class < ActiveGraph::ActiveRel
      ...
      def class_from_type(rel_type)
        ActiveGraph::ActiveRel::Types::WRAPPED_CLASSES[rel_type] || ActiveGraph::ActiveRel::Types::WRAPPED_CLASSES[rel_type] = rel_type.to_s.downcase.camelize
      end
    end
  end
end
