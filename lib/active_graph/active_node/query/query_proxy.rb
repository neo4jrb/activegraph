  ...
  module ActiveNode
    module Query
      ...
      class QueryProxy
        ...
        include ActiveGraph::ActiveNode::Query::QueryProxyEnumerable
        include ActiveGraph::ActiveNode::Query::QueryProxyMethods
        include ActiveGraph::ActiveNode::Query::QueryProxyMethodsOfMassUpdating
        include ActiveGraph::ActiveNode::Query::QueryProxyFindInBatches
        include ActiveGraph::ActiveNode::Query::QueryProxyEagerLoading
        include ActiveGraph::ActiveNode::Dependent::QueryProxyMethods
        ...
        # originated.
        # @param [ActiveGraph::ActiveNode::HasN::Association] association The ActiveNode association (an object created by a <tt>has_one</tt> or
        ...
        # @option options [ActiveGraph::ActiveNode] :source_object The node instance at the start of the QueryProxy chain
        ...
        def inspect
          formatted_nodes = ActiveGraph::ActiveNode::NodeListFormatter.new(to_a)
        ...
        def _query
          ActiveGraph::ActiveBase.new_query(context: @context)
        end
