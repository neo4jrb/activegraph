...
module ActiveGraph
  module ActiveNode
    ...
    module Labels
      ...
      include ActiveGraph::ActiveNode::Labels::Index
      include ActiveGraph::ActiveNode::Labels::Reloading
      ...
      included do |model|
        ...
        ActiveGraph::ActiveNode::Labels.add_wrapped_class(model) unless ActiveGraph::ActiveNode::Labels._wrapped_classes.include?(model)
      end
      ...
      module ClassMethods
        include ActiveGraph::ActiveNode::QueryMethods
        ...
        def base_class
          unless self < ActiveGraph::ActiveNode
