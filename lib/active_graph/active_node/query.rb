module ActiveGraph
  module ActiveNode
    ...
    module Query
      ...
      # @return [ActiveGraph::ActiveNode::Query::QueryProxy]
      def as(node_var)
      ...
      module ClassMethods
        ...
        ActiveGraph::ActiveNode::Query::QueryProxy::METHODS.each do |method|
        ...
        def query_proxy(options = {})
          ActiveGraph::ActiveNode::Query::QueryProxy.new(self, nil, options)
        end
