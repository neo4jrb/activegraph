  ...
  module ActiveNode
    module HasN
      class Association
        ...
        include ActiveGraph::ActiveNode::Dependent::AssociationMethods
        include ActiveGraph::ActiveNode::HasN::AssociationCypherMethods
        ...
        def discovered_model
          target_classes.select do |constant|
            constant.ancestors.include?(::ActiveGraph::ActiveNode)
          end
        end
