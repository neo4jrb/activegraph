module ActiveGraph::ActiveNode::HasN
  class Association
    class RelFactory
      ...
      def _match_query(other_node, wrapper)
        ...
        ActiveGraph::ActiveBase.new_query.match_nodes(nodes)
      end
      ...
      def _rel_wrapper(properties)
        ActiveGraph::ActiveNode::HasN::Association::RelWrapper.new(association, properties)
      end
    end
  end
end
