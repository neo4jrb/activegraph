module ActiveGraph::ActiveNode
  ...
  module Reflection
    ...
    module ClassMethods
      ...
      # @param association_object [ActiveGraph::ActiveNode::HasN::Association] the association object created in the course of creating this reflection
      ...
      # @return [ActiveGraph::ActiveNode::Reflection::AssociationReflection] of the given association
