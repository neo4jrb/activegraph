module ActiveGraph
  ...
  #
  # = ClassMethods
  # * {ActiveGraph::ActiveNode::Labels::ClassMethods} defines methods like: <tt>index</tt> and <tt>find</tt>
  # * {ActiveGraph::ActiveNode::Persistence::ClassMethods} defines methods like: <tt>create</tt> and <tt>create!</tt>
  # * {ActiveGraph::ActiveNode::Property::ClassMethods} defines methods like: <tt>property</tt>.
  #
  ...
  module ActiveNode
    ...
    include ActiveGraph::ActiveNode::Initialize
    include ActiveGraph::ActiveNode::IdProperty
    include ActiveGraph::Shared::SerializedProperties
    include ActiveGraph::ActiveNode::Property
    include ActiveGraph::ActiveNode::Reflection
    include ActiveGraph::ActiveNode::Persistence
    include ActiveGraph::ActiveNode::Validations
    include ActiveGraph::ActiveNode::Callbacks
    include ActiveGraph::ActiveNode::Query
    include ActiveGraph::ActiveNode::Labels
    include ActiveGraph::ActiveNode::Rels
    include ActiveGraph::ActiveNode::Unpersisted
    include ActiveGraph::ActiveNode::HasN
    include ActiveGraph::ActiveNode::Scope
    include ActiveGraph::ActiveNode::Dependent
    include ActiveGraph::ActiveNode::Enum
    include ActiveGraph::Shared::PermittedAttributes
    include ActiveGraph::ActiveNode::DependentCallbacks
    ...
    module ClassMethods
      def nodeify(object)
        if object.is_a?(::ActiveGraph::ActiveNode) || object.nil?
          object
        else
          self.find(object)
        end
    ...
    included do
      ...
      def self.inherited(other)
        ...
        ActiveGraph::ActiveNode::Labels.add_wrapped_class(other)
        super
      end
