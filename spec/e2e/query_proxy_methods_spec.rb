describe 'query_proxy_methods' do
  ...
  shared_examples 'is initialized correctly with associations' do
    it { should be_a(ActiveGraph::ActiveNode) }
  ...
  describe 'find_or_create_by' do
    ...
    it 'returns the node after creating' do
      expect(philosophy.students.find_or_create_by(name: 'Jacob')).to be_a(ActiveGraph::ActiveNode)
    end
  ...
  describe 'match_to and first_rel_to' do
    ...
    describe 'match_to' do
      it 'returns a QueryProxy object' do
        expect(@john.lessons.match_to(@history)).to be_a(ActiveGraph::ActiveNode::Query::QueryProxy)
        expect(@john.lessons.match_to(@history.id)).to be_a(ActiveGraph::ActiveNode::Query::QueryProxy)
        expect(@john.lessons.match_to(nil)).to be_a(ActiveGraph::ActiveNode::Query::QueryProxy)
      end
  ...
  describe 'branch' do
    ...
    it 'returns a QueryProxy object' do
      expect(@john.lessons.branch { teachers }).to be_a(ActiveGraph::ActiveNode::Query::QueryProxy)
    end
