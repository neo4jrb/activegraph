describe 'Relationship' do
  ...
  describe 'from_class, to_class' do
    ...
    it 'validates that the class is ' do
      ...
      expect { FromClass.create.other_others.to_a }.to raise_error ArgumentError, /Object is not an Node model/
    end
  end
  ...
  describe 'creation' do
    ...
    shared_context 'three-argument Relationship create/create!' do |meth|
    ...
    describe '#create' do
      it_behaves_like 'three-argument Relationship create/create!', :create
    end

    describe '#create!' do
      it 'raises an error on invalid params' do
        expect { RelClassWithValidations.create!(from_node: from_node, to_node: to_node) }.to raise_error ActiveGraph::Relationship::Persistence::RelInvalidError
      end
    ...
    describe '#save!' do
      it 'raises an error on invalid params' do
        ...
        expect { invalid_rel.save! }.to raise_error ActiveGraph::Relationship::Persistence::RelInvalidError
      end
      ...
      def self.it_is_expected_to_satisfy(class_method_value)
        context class_method_value.class.to_s do
          ...
          it 'fails when given a mismatched value' do
            expect { MyRelClass.create(from_node: OtherClass.create!, to_node: to_node) }.to raise_error ActiveGraph::Relationship::Persistence::ModelClassInvalidError
          end
    ...
    context 'with rel created from node' do
      ...
      context 'unsuccessfully' do
        it 'raises an error, does not create' do
          expect { f1.others.create(t1, should_be_nil: 'not nil') }.to raise_error ActiveGraph::Relationship::Persistence::RelInvalidError
