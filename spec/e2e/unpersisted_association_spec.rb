    ...
    context 'with math lesson' do
      ...
      describe 'has_one' do
        it 'creates the relationship by the association name' do
          ...
          lessons = chris.query_as(:c).match('c-[:FAVORITE_CLASS]->(l:Lesson)').pluck(l: Lesson.primary_key)
      ...
      describe 'has_many' do
        it 'creates the relationship by the association name' do
          ...
          lessons = chris.query_as(:c).match('c-[:ENROLLED_IN]->(l:Lesson)').pluck(l: Lesson.primary_key)
          expect(lessons).to match_array([math.id])
        end
