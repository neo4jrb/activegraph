...
==== Version < 2.0
* {Guides and API}[http://neo4j.rubyforge.org/guides/index.html], version < 2.0
* {RDoc}[http://neo4j.rubyforge.org] version < 2.0
...
* Layer 3. An implementation of the Rails Active Model and a subset of the Active Record API, see Neo4j::RailsNode and Neo4j::RailsRelationship class.
