...
This is because of performance - updates to lucene index should be made in a batch.
...
The index.find method simply delegates to the Lucene::IndexSearcher.
You use that class instead. It cache lucene IndexSearcher and check if it should
reload from disk.
