...
The following example demonstrate how to embed neo4j.rb with rails.
It has been verified to work on neo4j.rb 0.2.1 rail 2.2.2, JRuby 1.1.6 RC1, Glassfish 0.9.1.
