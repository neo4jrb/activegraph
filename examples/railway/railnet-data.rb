...
# Train t1_ae
t1_ab = alpha.rels.outgoing(:t1_ae) << bravo
t1_bc = bravo.rels.outgoing(:t1_ae) << charlie
t1_cd = charlie.rels.outgoing(:t1_ae) << delta
t1_de = delta.rels.outgoing(:t1_ae) << echo
...
# Train t2_ag
t2_af = alpha.rels.outgoing(:t2_ag) << foxtrot
t2_fc = foxtrot.rels.outgoing(:t2_ag) << charlie
t2_cd = charlie.rels.outgoing(:t2_ag) << delta
t2_dg = delta.rels.outgoing(:t2_ag) << golf
...
# Train t3_gh
t3_gd = golf.rels.outgoing(:t3_gh) << delta
t3_dh = delta.rels.outgoing(:t3_gh) << hotel
